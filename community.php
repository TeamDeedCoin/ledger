    ...
    <div class="container-fluid wow fadeIn" data-wow-delay="1s">
        <div class="row">
            <div class="col-md-12 pt100">
                <p class="pb30">Ledger Leap builds custom technology designed for growth hacking in the blockchain space. Our solutions can grow telegram and online audiences to 20k+ organically within a week. Once established, the ongoing support includes activating the community to multiply the audience through engagement campaigns. Ledger Leap can assure a responsive online presence.</p>
                <div class="col-md-6 col-sm-6">
                    <h3 class="orange">Initial Community Growth Hacking</h3>
                    <p>Engaging and rewarding real people online to show authentic audience growth fast.</p>
                    <h3 class="orange pt30">Outreach Campaign Management</h3>
                    <p>Communications designed to keep engagement high and aligned with sales phases.</p>
                    <h3 class="orange pt30">PR Content</h3>
                    <p>Journaling and creating content to build more impact online.</p>
                </div>
                <div class="col-md-6 col-sm-6">
                    <h3 class="orange">Community Campaigns</h3>
                    <p>Continued growth through content, contests, and discussion.</p>
                    <h3 class="orange pt30">Dedicated Global Support</h3>
                    <p>Cost effective staff designed to cover all time zones and respond in real time through all channels.</p>
                    <h3 class="orange pt30">Anti-Scam Protections</h3>
                    <p>Real-time response and protections from social engineering contribution theft.</p>
                </div>
            </div>
        </div>
    </div>
 ...
 */
    ...
    model_geo.load('objects/team.glb', function(gltf) {
        
        for(var i =0; i < gltf.scene.children[0].children[0].children.length; i++) {
            gltf.scene.children[0].children[0].children[i].material = custom_model_material;
        }
...
setTimeout(function() {
    ...
    setTimeout(function() {
        $("#jtext").html("Community Management & PR");
