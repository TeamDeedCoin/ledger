...
$(function(){
    ...
    var overviewTable = new TimelineMax()
    	.add(TweenMax.to("#tableOverview .row1", 0.4, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row2", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row3", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row4", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row5", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row6", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row7", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row8", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row9", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row10", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row11", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row12", 0.2, {css:{opacity: 1, right: 0}}))
    	.add(TweenMax.to("#tableOverview .row13", 0.2, {css:{opacity: 1, right: 0}}))
    ...
    var diagram = new TimelineMax()
    	.add(TweenMax.to(".dobject1", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline1", 0.3, {css:{width: '10%'}}))
    	.add(TweenMax.to(".dobject2", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline2", 0.3, {css:{height: '50px'}}))
    	.add(TweenMax.to(".dobject3", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline3", 0.3, {css:{width: '10%'}}))
    	.add(TweenMax.to(".dobject4", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline4-5", 0.3, {css:{height: '50px'}}))
    	.add(TweenMax.to(".dobject5", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline6-7", 0.3, {css:{height: '50px'}}))
    	.add(TweenMax.to(".dobject6", 0.3, {css:{opacity: 1}}))
    	.add(TweenMax.to(".dline8-9", 0.3, {css:{width: rWidth + 'px'}}))
    	.add(TweenMax.to(".dobject7", 0.3, {css:{opacity: 1}}))
...
$("#cararight").click(function(){
    if(caraactive == 1) {
        $("#partners1").fadeOut(200);
        setTimeout(function() {
            $("#partners2").fadeIn(200);
        },200);
        caraactive = 2;
    } else
    if(caraactive == 2) {
        $("#partners2").fadeOut(200);
        setTimeout(function() {
            $("#partners1").fadeIn(200);
        },200);
        caraactive = 1;
    }
});

$("#caraleft").click(function(){
    if(caraactive == 1) {
        $("#partners1").fadeOut(200);
        setTimeout(function() {
            $("#partners2").fadeIn(200);
